        ...
        <div className="w-full flex flex-col items-center">
            ...
            {kind === 'login' && (
                <View
                    ...
                    animate="visible"
                >
                    <Button type="button" kind="form" className="w-full gap-2 " onClick={handleLoginGoogle}>
                        <IonIcon name="logo-google" className="text-xl" />
                        <span>Đăng nhập với Google</span>
                    </Button>
                    <span className="text-sm text-cl-yellow-dark ">hoặc</span>
                </View>
            )}
            <form
            ...
            >
                ...
                {kind === 'register' && (
                    <View
                        ...
                        animate="visible"
                    >
                        <Label htmlFor="re_password" className="text-[15px]">
                            Nhập lại mật khẩu
                        </Label>
