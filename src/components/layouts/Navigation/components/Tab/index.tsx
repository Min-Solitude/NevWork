...
export default function Tab() {
    ...
    return (
        <div className="flex gap-2 items-center">
            <Link href={'/'}>
                <Button
                    className="bg-transparent hover:bg-cl-yellow-dark dark:hover:bg-transparent group border border-transparent dark:hover:border-cl-yellow"
                    kind="square"
                >
            ...
            <Button
                className="bg-transparent hover:bg-cl-yellow-dark group dark:hover:bg-transparent border border-transparent dark:hover:border-cl-yellow"
                kind="square"
            >
