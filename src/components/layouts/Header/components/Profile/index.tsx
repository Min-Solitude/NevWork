                ...
                <div className="w-full md:gap-16 gap-8 flex">
                    <div className="py-4 flex flex-col gap-4 ">
                        <div className="w-full  flex justify-start">
                            <Button
                                className={` duration-150 font-semibold text-[16px] text-xs md:text-base cursor-pointer ${isTab === 'profile'
                                    ? 'text-cl-yellow-dark '
                                    : 'text-cl-text-gray hover:text-cl-yellow-dark'
                                    }`}
                        ...
                        <div className="w-full  flex justify-start">
                            <Button
                                className={` duration-150 font-semibold text-[16px] text-xs md:text-base  cursor-pointer ${isTab === 'setting'
                                    ? 'text-cl-yellow-dark '
                                    : 'text-cl-text-gray hover:text-cl-yellow-dark'
                                    }`}
                        ...
                        <div className="w-full  flex justify-start">
                            <Button
                                className={` duration-150 font-semibold text-[16px] text-xs md:text-base  cursor-pointer ${isTab === 'logout'
                                    ? 'text-cl-yellow-dark '
                                    : 'text-cl-text-gray hover:text-cl-yellow-dark'
                                    }`}
                    ...
                    <div className=" flex-1 ">
                        <div className="md:h-[20vh] xs:h-[15vh] duration-150 h-[10vh] mt-4 w-full relative">
                            ...
                            {isBannerUrl && (
                                <Button
                                    className="px-4 absolute right-0 bottom-[-20%] py-1 rounded-lg bg-cl-yellow-dark text-black"
